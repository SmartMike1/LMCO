...
class Application(BasedWindow):
    ...
    def add_new(self):
        ...
        try:
            ...
            button = styled_button(window, text="Сохранить Информацию",
                            font=self.font, command=self.insert_changes)
    ...
    def search_for(self):
        self.window = BasedWindow(master=self.master, engine=engine,
                        title="Поиск Реактива", width=800, x=50, y=50)
        ...
        label = styled_label(self.form, text="Введите номер реактива:", font=self.font)
        ...
        button = styled_button(self.form, text="Найти", font=self.font, command=self.search)
    ...
    def search(self):
        ...
        if number == "":
            ...
            label = styled_label(self.form2, text=text1+text2, font=self.font)
            label.grid()
        else:
    ...
    def correct_Rinfo(self):
        self.Cwindow = BasedWindow(master=self.master, engine=engine,
                ...
                width=800, x=50, y=50) # width=620, height=450,
    ...
    def order_list(self, output_dir="."):
        try:
            ...
            filename = f"Список_реактивов_{today_str}.docx"
            output_path = f"{output_dir}/{filename}"

            doc = Document()
            doc.add_heading('Список реактивов для заказа', 0)
